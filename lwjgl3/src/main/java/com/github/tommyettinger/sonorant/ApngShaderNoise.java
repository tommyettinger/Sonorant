...
public class ApngShaderNoise extends ApplicationAdapter {
    ...
    public ApngShaderNoise(Clipboard clippy, long initialSeed) {
        clipboard = clippy;
        reseed(initialSeed);
    }
...
//		long state = System.nanoTime() + startTime;//-1234567890L;
    ...
    @Override public void resize (int width, int height) {
        ApngShaderNoise.width = width;
        ApngShaderNoise.height = height;
    ...
    @Override public void render () {
        ...
        if((Gdx.input.isKeyJustPressed(Input.Keys.ENTER) || Gdx.input.isKeyJustPressed(Input.Keys.F11)) && UIUtils.alt())
        {
            ...
            if (Gdx.app.getType() != Application.ApplicationType.WebGL && apng != null) {
                frames.clear();
                ...
                for (int i = frames.size - 2; i > 0; i -= 3) {
                    frames.removeIndex(i);
                    frames.removeIndex(i);
                }
                apng.write(Gdx.files.local("out/apng/" + seed + "_" + rMod + "_" + gMod + "_" + bMod + "_" + twist + "_" + width + "_" + height + ".png"), frames, 12);
            }
        }
    ...
    public static void main(String[] args) {
        ...
        new Lwjgl3Application(new ApngShaderNoise(new Lwjgl3Clipboard(), 1L), getDefaultConfiguration());
    }
